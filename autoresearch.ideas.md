...
- [observed] Removing `nlu_punctuate` from realtime ASR workflow produced consistent turn-complete latency gains on real-speech paced benchmark while preserving transcript presence.
